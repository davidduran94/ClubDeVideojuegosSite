				...
				<div class="fh5co-intro no-js-fullheight">
					<div class="fh5co-intro-text">
						...
						<div class="fh5co-center-position">
							<h2 class="animate-box">Equipo</h2>
							<h3 class="animate-box">Conócenos</h3>
				...
				<div class="row row-bottom-padded-lg">
					<div class="col-md-6">
						<figure class="animate-box">
							<img src="images/equipo.jpg" alt="" class="img-responsive">
						</figure>
					</div>
					<div class="col-md-6">
						<div class="fh5co-label animate-box">¿Quiénes somos?</div>
						<h2 class="fh5co-lead animate-box">Somos gamers </h2>
						<p class="fh5co-sub-lead animate-box">Esta es la pagina oficial perteneciente al Club de Desarrollo de Videojuegos de la ESCOM. Aquí podrás encontrar todo lo relacionado a este club.</p>
				</div>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-person">
							<figure class="animate-box">
								<img src="images/diego.png" alt="" class="img-responsive">
							</figure>
							<h3 class="fh5co-name animate-box">Diego Tovar </h3>
							<h4 class="fh5co-designation animate-box">Presidente</h4>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-person">
							<figure class="animate-box">
								<img src="images/person6.jpg" alt="" class="img-responsive">
							</figure>
							<h3 class="fh5co-name animate-box">Raul Vivanco</h3>
							<h4 class="fh5co-designation animate-box">Creative Director</h4>
							<p class="fh5co-bio animate-box">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
							<ul class="fh5co-social">
								<li class="animate-box"><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-person">
							...
							<h3 class="fh5co-name animate-box">Ruben </h3>
		...
		<div id="fh5co-info">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<figure class="animate-box">
							<img src="images/BYU.jpg" alt="" class="img-responsive">
						</figure>
					</div>
					<div class="col-md-6">
						<div class="fh5co-label animate-box">More about web</div>
						<h2 class="fh5co-lead animate-box">Why Blender y Unity?</h2>
