			...
			<div class="container">
				<div class="row row-bottom-padded-lg">
					...
					<div class="col-md-6">
						...
						<h2 class="fh5co-lead animate-box">Somos gamers(virgenes) </h2>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-person">	
							...
							<h3 class="fh5co-name animate-box">Diego Tovar (Lider) </h3>
							<h4 class="fh5co-designation animate-box">Presidente (corrupto)</h4>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-person">
							...
							<h3 class="fh5co-name animate-box">Raul Vivanco (escriva)</h3>
