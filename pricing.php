		...
		<section id="fh5co-pricing">
			<div class="container">
				...
				<div class="col-md-12 col-sm-12 animate-box">
					<div class="price-box">
						<h2 class="pricing-plan">Blood and Death</h2>
						<img src="images/juego_1.png" alt="">
						...
						<a href="#" class="btn btn-default btn-sm">Descargar</a>
					</div>
				</div>
			...
			<div class="container">
				<div class="row row-bottom-padded-lg">
					<div class="col-md-6 col-md-offset-3 text-center">
						<h2 class="fh5co-lead animate-box">Preguntas triviales y no triviales</h2>
					</div>
				</div>
				<div class="row">
